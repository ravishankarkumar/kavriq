...
description: Guide to the AI/ML tutorial structure (Python-first, Rust coming soon)
---
# Tutorial Roadmap
...
## Next Steps
- Begin with [Setup](/ml-essentials/getting-started/setup) to install Python (and optionally Rust).  
- Review [Tools](/ml-essentials/introduction/tools) for the libraries we'll use.  
