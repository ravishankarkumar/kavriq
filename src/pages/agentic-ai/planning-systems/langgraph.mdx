...
<Aside type="tip" title="Dual-Track Tutorial">
This article focuses on the **Python track** using LangGraph.

If you are following the **Rust track**, go to **[3.7 — Building Agents with Rig and Custom Graphs](/agentic-ai/planning-systems/rig)** instead.
</Aside>
