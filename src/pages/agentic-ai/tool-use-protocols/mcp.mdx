...
description: Understanding the Model Context Protocol for standardized tool discovery, its architecture, and implementing production-ready MCP servers in Rust and Python
...
<TabItem label="Rust (using rmcp, official rust sdk for mcp)" icon="seti:rust">
