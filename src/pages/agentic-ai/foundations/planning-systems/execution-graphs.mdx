...
>
> This is the abstraction shift from workflow graphs toward state machines, covered in [From DAGs to State Machines](/agentic-ai/engineering-agent-systems/from-dags-to-state-machines).

### Next Steps

- **Python track**: Continue to **[3.6 — Building Agents with LangGraph](/agentic-ai/foundations/planning-systems/langgraph)** — a practical guide to implementing stateful, graph-based agent architectures using one of the most popular modern frameworks.
