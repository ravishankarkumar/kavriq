...
→ Continue to **[2.8 — Reflection and Termination](/agentic-ai/foundations/agent-architecture/reflection-and-termination)**: How agents evaluate progress, detect errors, and decide when to stop.
