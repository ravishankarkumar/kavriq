...
>
> This is why tool design belongs inside the control architecture of an agent system, not just the integration layer. See [Controlled Agency](/agentic-ai/engineering-agent-systems/controlled-agency-tools-safety) for the systems-level view.
...
→ Continue to **[4.3 — The Model Context Protocol (MCP)](/agentic-ai/foundations/tool-use-protocols/mcp)**
