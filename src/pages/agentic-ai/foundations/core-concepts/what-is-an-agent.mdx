...
If your environment is not set up yet, please follow the [instructions here](/agentic-ai/foundations/prerequisite/setting-up) and then come back.
...
> For this exercise, runnable Python examples are available for both [Ollama](https://github.com/ravishankarkumar/kavriq-examples/blob/main/python/agentic-ai/01-foundations/what-is-an-agent-ollama.py) and [Gemini](https://github.com/ravishankarkumar/kavriq-examples/blob/main/python/agentic-ai/01-foundations/what-is-an-agent-gemini.py). Future examples will use Ollama by default unless a feature specifically needs another provider.
...
>
> That is why production agent design starts with the question explored in [The Engineering of Uncertainty](/agentic-ai/engineering-agent-systems/the-engineering-of-uncertainty): how do we build reliable systems around stochastic reasoning?

→ **Next up**: [The Cognitive Architecture of Agents](/agentic-ai/foundations/core-concepts/cognitive-architecture)
