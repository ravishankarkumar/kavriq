...
We have already seen structured output and persona-guided prompting in our previous examples. Let's take a look at them again.

* [Structured output Python example](https://github.com/ravishankarkumar/kavriq-examples/blob/main/python/agentic-ai/01-foundations/modern-llm-primitives/structured-output.py)
* [Persona-action-guardrail Python example](https://github.com/ravishankarkumar/kavriq-examples/blob/main/python/agentic-ai/01-foundations/modern-llm-primitives/pag.py)
...
→ **Next up**: [Internal Agent Architecture](/agentic-ai/foundations/agent-architecture)
