...
For the systems-level view of why these primitives become reliability problems in production, see [Engineering Agent Systems](/agentic-ai/engineering-agent-systems), especially [The Engineering of Uncertainty](/agentic-ai/engineering-agent-systems/the-engineering-of-uncertainty).
...
- [Cognitive Architecture](/agentic-ai/foundations/core-concepts/cognitive-architecture)
...
- [Inference-Time Compute](/agentic-ai/foundations/core-concepts/inference-time-compute)
...
### Next Steps
After mastering these foundations, you can explore how these components are assembled in [Agent Architecture](/agentic-ai/foundations/agent-architecture).
