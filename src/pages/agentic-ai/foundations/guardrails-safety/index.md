...
Agent safety is not only about model behavior; it is also runtime control over what actions are allowed. For that production framing, see [Controlled Agency](/agentic-ai/engineering-agent-systems/controlled-agency-tools-safety).
